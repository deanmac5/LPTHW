...
class CentralCorridor(Scene):
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "fldsjflj fsdljfl fsfjlsjgl tljlj."
            print "The Gothon stops, tries not to laugh, then busts out laughing and can't move."
            print "While he's laughing you run up and shoot him square in the head"
            print "putting him down, then jump through the Weapon Armoury door."
...
class LaserWeaponArmoury(Scene):
    def enter(self):
        ...
        print "wrong 10 times then teh lock closes forever and you can't"
        ...
        if guess == code:
            ...
            print "The lock buzzes one last time and your hear a sickening"
...
class EscapePod(Scene):
    def enter(self):
        print "You rush through teh ship desparately trying to make it to"
